		...
		try {
			...
			case NUMERIC: {
				if (DateUtil.isCellDateFormatted(cell)) {
					rowCellData = new SimpleDateFormat("yyyy-MM-dd").format(cell.getDateCellValue());
				} else {
					rowCellData = String.valueOf(cell.getNumericCellValue());
				}
				break;
			}
			case BOOLEAN: {
				rowCellData = String.valueOf(cell.getBooleanCellValue());
			}
			case BLANK: {
				rowCellData = "";
				break;
