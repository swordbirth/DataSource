...
public class DataSource {
	...
	public DataSource(String index, String major, String class_name, String truancy_rate, String late_rate,
			String leave_rate, String attendance_rate, String attendance_ranking) {
		this.idx = index;
		this.major = major;
	...
	public String showData() {
		return "DataSource [index=" + idx + ", major=" + major + ", class_name=" + class_name + ", truancy_rate="
				+ truancy_rate + ", late_rate=" + late_rate + ", leave_rate=" + leave_rate + ", attendance_rate="
				+ attendance_rate + ", attendance_ranking=" + attendance_ranking;
	}
}
